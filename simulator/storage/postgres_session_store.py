...
class PostgresSessionStore(SessionStore):
    ...
    def _connect(self):
        # connect_timeout: fail fast and loud on a bad/unreachable connection
        # instead of hanging silently (TCP retries with no timeout can hang
        # for minutes, which looks exactly like "the button did nothing").
        return self._psycopg2.connect(self._conn_string, connect_timeout=10)
